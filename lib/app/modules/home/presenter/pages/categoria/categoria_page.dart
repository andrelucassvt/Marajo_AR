...
class _CategoriaPageState extends State<CategoriaPage> {
  ...
  final BannerAd myBanner = BannerAd(
    adUnitId: Platform.isIOS
        ? 'ca-app-pub-3652623512305285/2053989791'
        : 'ca-app-pub-3652623512305285/1107829897',
    size: AdSize.banner,
    request: AdRequest(),
  ...
  void didChangeDependencies() {
    ...
    controller.getCategoriaList(
        CategoriaDto(categoriasEnum: params, context: context));
