...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "CoreDataListAcaiDesc": MessageLookupByLibrary.simpleMessage(
            "O açaí se popularizou e se constituiu como base alimentar de todas as populações no entorno do Amazonas, hábito que perpassa séculos e ainda se mantém na cultura local. Não apenas por tradição, mas porque o fruto é repleto de nutrientes, como se descobriu mais tarde por pesquisas científicas. Em algumas populações, come-se açaí no café da manhã, no almoço e no jantar. No início do dia, ele é cozido com tapioca ou arroz e temperado com sal. "),
        "CoreDataListAcaiName":
